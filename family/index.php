...
<html lang="en">
    ...
    ?>
        <div id="wrapper">
            <div id="menu">
                <p class="welcome">Welcome to Family Chat, <b><?php echo $_SESSION['name'];?></b>!</p>
      ...
      <a href="https://ifdchat.ifdoop.repl.co/index.php"><button>Main Room</button></a><br><a href="https://ifdchat.ifdoop.repl.co/001/index.php"><button>ROOM 001</button></a><br><a href="https://ifdchat.ifdoop.repl.co/002/index.php"><button>ROOM 002</button></a><br>
<a href="https://ifdchat.ifdoop.repl.co/vintage/index.php"><button>Vintage Look</button></a><a href="https://ifdchat.ifdoop.repl.co/index.php"><button>HOME</button></a>
